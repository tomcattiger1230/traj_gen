...
'''
Author: Wei Luo
Date: 2020-07-30 09:19:20
LastEditors: Wei Luo
LastEditTime: 2020-09-11 11:19:27
Note: Note
'''

import numpy as np
from traj_gen import chomp_trajectory as opt_t
import time
...
if __name__ == '__main__':
    ...
    optTraj = opt_t.CHOMPTrajGen(knots, dim, pntDensity)
    ...
    # pin_ = {'t':ts[0], 'd':0, 'X':Xs[0]}
    # optTraj.addPin(pin_)
    # pin_ = {'t':ts[-1], 'd':0, 'X':Xs[-1]}
    # optTraj.addPin(pin_)
